...
<body class="theme-red">
             ...
             <div class="row clearfix ">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<a href="member1.php"  class="btn btn-success waves-effect" >
	...
	$mem_type = strip_tags($mem_type );
	$mem_type  = htmlspecialchars($mem_type );
}

	 $results = mysqli_query($db, "SELECT * FROM member WHERE mem_type='$mem_type'"); ?> 
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td><?php echo $row['mem_contact']; ?></td>
			...
			<td>
				<a href="member1.php?edit=<?php echo $row['mem_id']; ?>" class="edit_btn" ><i class="material-icons">mode_edit</i></a>
			</td>
			<td>
				<a onClick="javascript: return confirm('Please confirm deletion')" href="member2.php?del=<?php echo $row['mem_id']; ?>"><i class="material-icons">delete</i></a>
