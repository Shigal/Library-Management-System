...
<body class="theme-red">
	...
	$query2 = "SELECT category,COUNT(book_id) FROM book GROUP BY category";
			 ...
			 <tr>
			   ...
			   <th><center>Quantity</center></th>
					...
					while($query2_row=mysql_fetch_assoc($query2_run))
						{
							$category = $query2_row['category'];
							$quantity = $query2_row['COUNT(book_id)'];
   
							echo "<tr>";
						
							echo "<td><form action = \"book.php\" method = \"post\"><input type = \"hidden\" name = \"category\" value = \" ".$category."\" style=\"text-decoration:none\"/><input type=\"submit\" value=\" ".$category."\" style=\"width:100%;border:none\"/></form></td>"; 
																
							echo "<td><center>".$quantity."</center></td></tr>";
						}
						echo"</table>";
				}
					}
