...
include("../db_conn.php");
	if(isset($_POST['submit1'])) {
		...
		$query1 = "SELECT * FROM issue_status WHERE enroll_no='$_POST[enr]' AND return_date='' ";
		$query2 = mysqli_query($db,"SELECT * FROM issue_status WHERE enroll_no='$_POST[enr]' AND return_date='' ");
		...
		while($row1 = mysqli_fetch_array($query2)){
			...
			echo "<td>"; echo $row1['issued_book_no']; echo "</td>";
				$_SESSION['issued_book_no'] = $row1['issued_book_no'];
