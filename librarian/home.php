...
<?php
	...
	$query3 = "SELECT * FROM issue_status WHERE return_date=''";
	$query4 = "SELECT * FROM request WHERE approve=''";
		
				if($query1_run = mysql_query($query1) AND $query2_run = mysql_query($query2) AND $query3_run = mysql_query($query3) AND $query4_run = mysql_query($query4)){
						$count1 = mysql_num_rows($query1_run);
						$count2 = mysql_num_rows($query2_run);
						$count3 = mysql_num_rows($query3_run);
						$count4 = mysql_num_rows($query4_run);
				}
				if($count1 == null AND $count2 == null AND $count3 == null AND $count4 == null)
					{
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12"> 
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Total Number of Requests</div>
                            <div class="number count-to" data-from="0" data-to="<?=$count4;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
  ...
  <?php 
	...
	?>
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="<?=$count3;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
