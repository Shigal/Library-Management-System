             ...
             <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
						<div class="wrapper">
						<form action="<?php echo $_SERVER["PHP_SELF"]?>" method="post" id="form_advanced_validation">
									<label class="form-label">Title / Author / Category </label>
					...
					while($query4_row=mysql_fetch_assoc($query4_run))
										{
											...
											$category = $query4_row['category'];
											$edition = $query4_row['edition'];
											$publisher = $query4_row['publisher'];
											$year = $query4_row['year'];
											$status = $query4_row['status'];
											
											echo"<tr><td>".$isbn."</td><td>".$book_no."</td><td>".$title."</td><td>".$author."</td><td>".$category."</td><td>".$edition."</td><td>".$publisher."</td><td>".$year."</td><td>".$status."</td></tr>";											
										}		
					echo"</table>";
					}
					}
