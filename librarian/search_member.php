    ...
    <section class="content">
        <div class="container-fluid">
			...
			<ol class="breadcrumb breadcrumb-bg-teal align-right">
                ...
                <li><a href="#"><i class="material-icons">people</i> Members</a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<form action="<?php echo $_SERVER["PHP_SELF"]?>" method="post">
									<label> Name / Type / Username</label>
...
<?php
				...
				if(isset($_POST['submit'])){
					include('../db_conn.php');	
				$query4 = "SELECT * FROM member WHERE mem_name LIKE '%{$_POST['name']}%' OR mem_type LIKE '%{$_POST['name']}%' OR mem_username LIKE '%{$_POST['name']}%'";	
				echo"<br>";
               ...
               echo" <table class='table table-bordered table-striped table-hover js-basic-example dataTable'>
                  <thead>
					...
					while($query4_row=mysql_fetch_assoc($query4_run))
										{
											$mem_id = $query4_row['mem_id'];
											$mem_name = $query4_row['mem_name'];											
											$email = $query4_row['mem_email'];
											$mem_type = $query4_row['mem_type'];
											$reg_date = $query4_row['reg_date'];
											
											echo"<tr><td>".$mem_id."</td><td>".$mem_name."</td><td>".$email."</td><td>".$mem_type."</td><td>".$reg_date."</td></tr>";											
										}		
					echo"</table>";
					}
					}
