                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<form action="<?php echo $_SERVER["PHP_SELF"]?>" method="post">
									<label>Enter Title or Author </label>
									<input type="textarea" required name="name"></input>
									<input type="submit" name="submit" value="Search Now!"></input>
								</form>
						</div>
...
<?php
				...
				if(isset($_POST['submit'])){
					include('db_conn.php');	
				$query4 = "SELECT * FROM book WHERE title LIKE '%{$_POST['name']}%' OR author LIKE '%{$_POST['name']}%'";	
				echo"<br>";
					...
					while($query4_row=mysql_fetch_assoc($query4_run))
										{
											...
											echo"<tr><td>".$isbn."</td><td>".$title."</td><td>".$author."</td><td>".$edition."</td><td>".$publisher."</td><td>".$year."</td><td>".$status."</td></tr>";											
										}		
					echo"</table>";
					}
					}
