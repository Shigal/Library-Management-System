...
<body class="theme-red">
                    ...
                    <div class="card">
						...
						<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
							...
							<div class="form-group form-float">
								...
								<div class="form-group form-float">
								<input type="submit" value="Request Book" name="submit1" class=" btn btn-primary " style="margin-top: 20px;">
								</div>
							</div>
						</form>
						<?php
	...
	if(isset($_POST['submit1'])){
		...
		if(mysqli_num_rows($result) == 0){
			$query = "INSERT INTO request(id, message, logs) VALUES('$mem_id', '{$_POST['message']}', now())";
		...
		if(!$res){
			...
			<div class="alert alert-success alert-dismissible" role="alert">
				...
				Book request send to Librarian!
			</div>
			<?php
		}
		}
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				Sorry, You can request only one book & you have already requested a book!
			</div>
			<?php
		}
