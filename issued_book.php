    ...
    <section class="content">
        <div class="container-fluid">
			...
			<ol class="breadcrumb breadcrumb-bg-teal align-right">
				<div class="pull-left"><h2>BOOKS ISSUED </h2></div>
...
<table class="table">
	...
	<?php
		$result = mysqli_query($db, "SELECT * FROM issue_status WHERE mem_username='$_SESSION[username]'");
